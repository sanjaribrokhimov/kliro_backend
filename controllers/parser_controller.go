...
rate_min: минимальная процентная ставка (только число, если указано, иначе — null)
rate_max: максимальная процентная ставка (только число, если указано, иначе — null)
...
Если указано только ставка от или только до, заполни только одно из полей: rate_min или rate_max. Второе — null.
